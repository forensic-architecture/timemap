...
import './common/index-7edab99c.js';
import { b as bindActionCreators } from './common/bindActionCreators-145ee202.js';
...
_ref) {
  ...
  return function wrapWithConnect(WrappedComponent) {
    browser(reactIs.isValidElementType(WrappedComponent), "You must pass a component to the function returned by " + (methodName + ". Instead received " + JSON.stringify(WrappedComponent)));
...
export { Provider, connect, connectAdvanced, createProvider };
