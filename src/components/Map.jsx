...
class Map extends React.Component {
  ...
  initializeMap() {
    ...
    if (
      ...
      keyFromEnv('MAPBOX_TOKEN') &&
      keyFromEnv('MAPBOX_TOKEN') !== defaultToken
    ) {
      firstLayer = L.tileLayer(
        `http://a.tiles.mapbox.com/v4/mapbox.${
          this.props.ui.tiles
        }/{z}/{x}/{y}@2x.png?access_token=${keyFromEnv('MAPBOX_TOKEN')}`,
      );
    } else if (
      keyFromEnv('MAPBOX_TOKEN') &&
      keyFromEnv('MAPBOX_TOKEN') !== defaultToken
      ...
      firstLayer = L.tileLayer(
        `http://a.tiles.mapbox.com/styles/v1/${
          this.props.ui.tiles
        }/tiles/{z}/{x}/{y}?access_token=${keyFromEnv('MAPBOX_TOKEN')}`,
      );
    } else {
      firstLayer = L.tileLayer(
